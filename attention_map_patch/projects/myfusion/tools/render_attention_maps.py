...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        '--output',
        default=(
            'projects/myfusion/evaluation_assets/'
    ...
    parser.add_argument(
        ...
        help='Sample IDs excluded when replacing an existing figure.')
    parser.add_argument('--pedestrian-samples', nargs='*', type=int)
    parser.add_argument('--cyclist-samples', nargs='*', type=int)
    parser.add_argument('--car-samples', nargs='*', type=int)
